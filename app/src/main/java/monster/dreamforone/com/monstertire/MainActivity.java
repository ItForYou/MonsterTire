package monster.dreamforone.com.monstertire;
...
public class MainActivity extends AppCompatActivity {
    LinearLayout networkLayout,webLayout;
    WebView webView;
    ...
    public void setLayout(){
        networkLayout=(LinearLayout)findViewById(R.id.networkLayout);//네트워크 연결이 끊겼을 때 레이아웃 가져오기
